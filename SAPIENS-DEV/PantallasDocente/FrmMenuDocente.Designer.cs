namespace SAPIENS_DEV.PantallasDocente
{
	partial class FrmMenuDocente
	{
		...
		private void InitializeComponent()
		{
			...
			this.SuspendLayout();
			// pnlEstado (barra inferior índigo)
			...
			// pnlMenu (menú lateral 280px según guía)
			...
			// botones de navegación (ítem normal: texto #6B7280, altura 48)
			...
			this.btnReportes.ForeColor = System.Drawing.Color.FromArgb(107, 114, 128);
			...
			// pnlContenido (área de contenido #F9FAFB según guía)
